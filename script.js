...
function main() {
  ...
  var userInputValueconverted = userInputValue.toLowerCase();
  fetch("https://pokeapi.co/api/v2/pokemon/" + userInputValueconverted)
    .then((res) => res.json())
    .then((data) => {
      ...
      abilitiestag.innerText = "Abilities:" + abilities.join(", ");
